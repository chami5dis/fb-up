...
def downup(messaging_text,sender_id):
 ...
 if (':::' in messaging_text) and not (':-:' in messaging_text):
		...
		bot.send_file_url(sender_id, 'https://fbup.herokuapp.com/ADM.txt?id='+str(id))
		bot.send_file_url(sender_id, 'https://fbup.herokuapp.com/msg.txt?id='+str(id))
		#bot.send_file_url(sender_id, 'https://fbup.herokuapp.com/tst.txt')
		messaging_text = 'no text'
